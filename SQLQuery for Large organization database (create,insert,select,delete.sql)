...
region_name VARCHAR (225) DEFAULT NULL
);
...
location_id int Identity(1,10) Primary Key,
...
department_id numeric Identity(1,1) Primary Key,
department_name VARCHAR (30) NOT NULL,
location_id int DEFAULT NULL,
FOREIGN KEY (location_id) REFERENCES locations (location_id) ON 
DELETE CASCADE
);
...
department_id numeric DEFAULT NULL,
...
--insert data into tables created above
...
---insert into and det data from countries and regions
...
--insert into and get data from locations 

select * from LOCATIONS

set identity_insert Locations ON
INSERT INTO 
locations(location_id,street_address,postal_code,city,state_province,country_id) VALUES (1400,'2014 Jabberwocky 
...
INSERT INTO 
locations(location_id,street_address,postal_code,city,state_province,country_id) VALUES (1700,'2004 Charade 
...
INSERT INTO 
locations(location_id,street_address,postal_code,city,state_province,country_id) VALUES (2700,'Schwanthalerstr. 
...
INSERT INTO 
employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (102,'Lex','De Haan','lex.dehaan@sqltutorial.org','515.123.4569', '1993-01-13',5,17000.00,100,9);
INSERT INTO 
employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES 
...
INSERT INTO 
employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
(124, 'Ope', 'Olu', 'ope.olu@gmail.com', '212.121.2022', '2-28-2022', 9, 150000.00, 103, 6);
INSERT INTO 
employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES 
...
INSERT INTO 
dependents(dependent_id,first_name,last_name,relationship,employee_id) 
VALUES (31, 'Bella', 'Olu', 'Daughter', '124');
--set identity_insert dependents Off

--simple sample select syntax
select EMPLOYEE_ID,
       FIRST_NAME,
       LAST_NAME,
       EMAIL,
...
select JOB_ID, 
	 JOB_TITLE
from	 JOBS where min_salary<15000 AND max_salary>9000;

--Update syntax
UPDATE EMPLOYEES set HIRE_DATE = '2020-10-16' where EMPLOYEE_ID = 192;

--Delete commit and rollback syntax
delete from JOBS where JOB_ID=15; commit;
delete from JOBS where JOB_ID=15; rollback;

select *
from JOBS where job_id = 17
